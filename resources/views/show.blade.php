	...
	<div class="section">
		<form action="{{ url('query') }}" method="GET">
   			 <div class="row">
          		<div class="input-field col s12">
            		<input type="text" class="validate" required name="q">
		...
		<div class="row">
			<div class="col s12">
				...
				<p style="text-align:justify;">{!!substr($data->isi,0,200)!!}...</p>
				...
				<a href="{{ url('delete', $data->id) }}" onclick="return confirm('Yakin mau hapus data {{$data->judul}}?')" class="btn btn-flat red darken-4 waves-effect waves-light white-text">Delete <i class="material-icons right">delete</i></a>
			</div>
		</div>
